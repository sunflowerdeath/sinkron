...
export class Initial1710591074633 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "invite" ("id" varchar PRIMARY KEY NOT NULL, "spaceId" varchar NOT NULL, "role" varchar NOT NULL, "fromId" varchar NOT NULL, "toId" varchar NOT NULL, "createdAt" datetime NOT NULL DEFAULT (datetime('now')), "updatedAt" datetime NOT NULL DEFAULT (datetime('now')), "status" varchar NOT NULL, "notificationHidden" boolean NOT NULL)`);
        ...
        await queryRunner.query(`CREATE TABLE "temporary_invite" ("id" varchar PRIMARY KEY NOT NULL, "spaceId" varchar NOT NULL, "role" varchar NOT NULL, "fromId" varchar NOT NULL, "toId" varchar NOT NULL, "createdAt" datetime NOT NULL DEFAULT (datetime('now')), "updatedAt" datetime NOT NULL DEFAULT (datetime('now')), "status" varchar NOT NULL, "notificationHidden" boolean NOT NULL, CONSTRAINT "FK_743841b40e6160a14972f930676" FOREIGN KEY ("spaceId") REFERENCES "space" ("id") ON DELETE NO ACTION ON UPDATE NO ACTION, CONSTRAINT "FK_0d683af0f9844ed115756f559f4" FOREIGN KEY ("fromId") REFERENCES "user" ("id") ON DELETE NO ACTION ON UPDATE NO ACTION, CONSTRAINT "FK_9f0e8951f9decd5a33d34f3357a" FOREIGN KEY ("toId") REFERENCES "user" ("id") ON DELETE NO ACTION ON UPDATE NO ACTION)`);
        await queryRunner.query(`INSERT INTO "temporary_invite"("id", "spaceId", "role", "fromId", "toId", "createdAt", "updatedAt", "status", "notificationHidden") SELECT "id", "spaceId", "role", "fromId", "toId", "createdAt", "updatedAt", "status", "notificationHidden" FROM "invite"`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "invite" ("id" varchar PRIMARY KEY NOT NULL, "spaceId" varchar NOT NULL, "role" varchar NOT NULL, "fromId" varchar NOT NULL, "toId" varchar NOT NULL, "createdAt" datetime NOT NULL DEFAULT (datetime('now')), "updatedAt" datetime NOT NULL DEFAULT (datetime('now')), "status" varchar NOT NULL, "notificationHidden" boolean NOT NULL)`);
        await queryRunner.query(`INSERT INTO "invite"("id", "spaceId", "role", "fromId", "toId", "createdAt", "updatedAt", "status", "notificationHidden") SELECT "id", "spaceId", "role", "fromId", "toId", "createdAt", "updatedAt", "status", "notificationHidden" FROM "temporary_invite"`);
